    ...
    <main className="min-h-screen px-4 py-8 sm:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <a href="https://entra.microsoft.com/#view/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/~/Authentication/appId/71bdbc9d-3e5a-4665-bad5-965bc28b894b/isMSAApp~/false" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-xl bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 px-4 py-2 text-sm text-blue-300 font-medium transition-colors">
